...
<div class="col-span-6 sm:col-span-4 mt-3">
    ...
    <x-jet-input id="leerweg" name="leerweg"
                 value="{{optional($company)->leerweg}}" type="text"
...
<div class="form-row col-span-6 sm:col-span-4 mt-3">
    <div class="col-4">
        ...
        <x-jet-input id="aantal_plaatsen" name="aantal_plaatsen"
                     value="{{optional($company)->aantal_plaatsen}}" type="number"
                     class="mt-1 block w-full"
...
<div class="form-row col-span-6 sm:col-span-4 mt-3">
    ...
    <x-jet-input id="wat_te_doen" name="wat_te_doen" value="{{optional($company)->wat_te_doen}}"
    ...
    <div class="form-row col-span-6 sm:col-span-4 mt-3">
        ...
        <x-jet-input id="werkzaamheden" name="werkzaamheden" value="{{optional($company)->werkzaamheden}}"
                     type="textarea" class="mt-1 block w-full"
...
<div class="form-row col-span-6 sm:col-span-4 mt-3">
    ...
    <x-jet-input id="wat_zoeken_wij" name="wat_zoeken_wij"
                 value="{{optional($company)->wat_zoeken_wij}}" type="textarea"
                 class="mt-1 block w-full"
