<form id="locationForm" method="Post" action="{{route('locatie.store')}}">
    <x-form.modal title="Nieuwe locatoe toevoegen">
        ...
        <div class="col-span-6 sm:col-span-4 mt-1">
            ...
            <x-jet-input id="name" name="name" :value="old('name')" type="text" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4 mt-3">
            ...
            <x-jet-input id="street" name="street" :value="old('street')" type="text" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4 mt-3">
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <x-jet-input id="nr" name="house_nr" :value="old('house_nr')" type="number" min="1"
                                 placeHolder="nr."
                                 class="mt-1 block w-full" autocomplete="street"
                                 oninput="validity.valid||(value='');"/>
                </div>
                <div class="col-md-2">
                    <x-jet-input id="addition" name="house_nr_addition" :value="old('house_nr_addition')" type="text"
        ...
        <div class="form-row col-span-6 sm:col-span-4 mt-3">
            <div class="col-4">
                ...
                <x-jet-input id="zip" name="zip_code" :value="old('zip_code')" type="text" class="mt-1 block w-full"
        ...
        <div class="form-row col-span-6 sm:col-span-4 mt-3">
            ...
            <x-jet-input id="city" name="city" :value="old('city')" type="text" class="mt-1 block w-full"
        ...
        <div class="form-row col-span-6 sm:col-span-4 mt-3">
            ...
            <x-jet-input id="email" name="email" :value="old('email')" type="text" class="mt-1 block w-full"
        ...
        <div class="form-row col-span-6 sm:col-span-4 mt-3">
            ...
            <x-jet-input id="phone" name="phone_nr" :value="old('phone_nr')" type="text" class="mt-1 block w-full"
